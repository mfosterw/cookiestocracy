...
class Person(TimeStampedModel):
    ...
    def get_absolute_url(self):
        ...
        """
        return reverse("social:person-detail", kwargs={"username": self.display_name})

    def get_follow_url(self):
        return reverse("social:person-follow", kwargs={"username": self.display_name})
...
class Note(TimeStampedModel, MPTTModel):
    ...
    def get_absolute_url(self):
        ...
        """
        return reverse("social:note-detail", kwargs={"pk": self.pk})

    def get_like_url(self):
        return reverse("social:note-like", kwargs={"pk": self.id})
    ...
    def get_repost_url(self):
        return reverse("social:note-repost", kwargs={"pk": self.id})
