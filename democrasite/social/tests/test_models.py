...
class TestPerson:
    ...
    def test_get_absolute_url(self, person: Person):
        assert person.get_absolute_url() == f"/social/person/{person.user.username}/"

    def test_get_follow_url(self, person: Person):
        assert (
            person.get_follow_url() == f"/social/person/{person.user.username}/follow/"
        )
...
class TestNote:
    ...
    def test_get_absolute_url(self, note: Note):
        assert note.get_absolute_url() == f"/social/notes/{note.pk}/"

    def test_get_like_url(self, note: Note):
        assert note.get_like_url() == f"/social/notes/{note.id}/like/"
    ...
    def test_get_repost_url(self, note: Note):
        assert note.get_repost_url() == f"/social/notes/{note.id}/repost/"
